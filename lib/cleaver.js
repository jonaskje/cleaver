...
var marked = require('jkmarked');
var hljs = require('highlight.js');
var yaml = require('js-yaml');
var mustache = require('mustache');
var ditaa = require('node-ditaa');
var fs = require('fs');
var helper;
...
function Cleaver(document, includePath) {
  ...
  marked.setOptions({
    gfm: true,
	imager: function (code, lang) {
		var hash = code.hashCode();
		if (hash < 0) hash = 0xffffffff + hash + 1; // two's complement negative numbers
		var path = 'image_' + hash.toString(16) + '.png';
		ditaa(
		  code, 
